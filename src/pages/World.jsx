    ...
    <div className="page page-world">
      ...
      <section className="world-section">
        ...
        <div className="card-grid">
          ...
          <div className="book-card">
            <h3>Mekhu</h3>
            <p>A northern Greek-inspired land controlled through its religious hub, Adelfi, seat of the Antholic Church and its Templar Knights, though it's capital lies in Theron.</p>
          </div>
          <div className="book-card">
            <h3>Grecca</h3>
